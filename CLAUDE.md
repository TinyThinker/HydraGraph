...
| Question | File |
|---|---|
| Where is the project now? | `docs/STATUS.md` (auto-generated — never hand-edit) |
...
`docs/CHANGELOG.md`, then run `/sync-docs` to regenerate `docs/STATUS.md`. Do not create
"phase progress", "current state", or "tasks" files — that role is STATUS.md + ROADMAP.md.
Records of completed work / diagnoses are born in `docs/archive/` and never edited after.
